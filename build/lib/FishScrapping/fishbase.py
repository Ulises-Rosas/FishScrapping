...
class Fishbase:
    ...
    * Get length-weight relationships with `lw_relationship()` function
    ...
    def __init__(self, species):
        ...
        self.host = "https://www.fishbase.in"
        self.summary_url         = self.host + "/summary/"
        self.no_record_url       = self.host + "/Nomenclature/ScientificNameSearchList.php?Genus="
        self.synonym_url         = self.host + "/Nomenclature/SynonymsList.php?ID="
        self.lw_relationship_url = self.host + "/popdyn/LWRelationshipList.php?ID="
        self.keyfacts            = self.host + "/popdyn/KeyfactsSummary_1.php?ID="
    ...
    def keyfacts(self):
        ...
        if wid != self.consider_review:
            ...
            return "{0}{1}".format(self.species, "\tcheck_spell" * nout)
